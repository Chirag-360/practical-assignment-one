...
export const AdPanel = () => {
  const ads = [
    {
      icon: 'public/adIcons/trophy 1.png',
      title: 'High Quality',
      subtitle: 'crafted from top materials',
    },
    {
        icon: 'public/adIcons/guarantee.png',
        title: 'Warranty Protection',
      subtitle: 'Over 2 years',
    },
    {
        icon: 'public/adIcons/present.png',
        title: 'Free Shipping',
      subtitle: 'Order over 150 $',
    },
    {
        icon: 'public/adIcons/support.png',
        title: '24 / 7 Support',
  ...
  return (
    <div className=" flex flex-wrap justify-between p-4 bg-orange-50 mt-3">
      {ads.map((ad, index) => (
        <div key={index} className="w-full md:w-1/2 lg:w-1/4 flex justify-center my-16 p-4 bg-transparent">
