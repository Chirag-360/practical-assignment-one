  ...
  return (
    <nav className="bg-white border-gray-200">
      <div className="flex flex-wrap items-center justify-between p-4 mx-4 md:mx-20">
        ...
        <div className="flex md:hidden"> {/* Show on small screens only */}
        ...
        <div className="hidden md:flex items-center gap-10"> 
          <span className="text-gray-600">
            <img src="./public/Icons/Vector.png" alt="Icon 1" className="mr-3" />
          </span>
          <span className="text-gray-600">
            <img src="./public/Icons/Vector(1).png" alt="Icon 2" className="mr-3" />
          </span>
          <span className="text-gray-600">
            <img src="./public/Icons/Vector(2).png" alt="Icon 3" className="mr-3" />
          </span>
          <span className="text-gray-600">
            <img src="./public/Icons/Vector(3).png" alt="Icon 4" className="mr-3" />
          </span>
        </div>
      </div>
    </nav>
